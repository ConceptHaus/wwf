...
Route::delete('/casos/{id}','Admin\AdminController@deleteCaso');
Route::get('/casos/{id}','Admin\AdminController@getOneCaso');
Route::delete('/recursos/{id}','Admin\AdminController@deleteRecurso');
Route::get('/recursos/{id}','Admin\AdminController@getOneRecurso');
